...
- `library/cineprompt-library.js`: canonical ontology, user-facing category groups, evidence status, relationships, semantic traits, audit metadata, and model profiles.
...
- `src/storage-migration.js`: backward-compatible migration for current `cine_v4_ontology` states and legacy `cine_v15_2_authority` records.
